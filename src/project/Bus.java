...
public class Bus extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{ 
            String sql= "INSERT INTO bus VALUES ('"+jTextField1.getText()+"',"
                    + "'"+jTextField2.getText()+"',"
                    + "'"+jTextField3.getText()+"',"
                    + "'"+jTextField4.getText()+"',";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try {
            String sql="DELETE FROM bus WHERE id_bus='"+jTextField1.getText()+"'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            String sql="UPDATE bus SET id_bus='"+jTextField1.getText()+"',"
                    + "nama_bus='"+jTextField2.getText()+"',"
                    + "warna_bus='"+jTextField3.getText()+"',"
                    + "nomor_polisi='"+jTextField4.getText()+"' WHERE id_bus='"+jTextField1.getText()+"'";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        try{
            InputStream is = Bus.class.getResourceAsStream("/Laporan/bus.jasper");
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        String id_bus = jTable2.getValueAt(baris, 1).toString();
        jTextField1.setText(id_bus);
        String nama_bus = jTable2.getValueAt(baris, 2).toString();
        jTextField2.setText(nama_bus);
        String warna_bus = jTable2.getValueAt(baris, 3).toString();
        jTextField3.setText(warna_bus);
        String nomor_polisi = jTable2.getValueAt(baris, 4).toString();
        jTextField4.setText(nomor_polisi);
